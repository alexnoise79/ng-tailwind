    ...
    <div class="space-y-12">
      <section>
        ...
        <p class="text-gray-600 mb-4">
          Welcome to ng-tailwind UI Components - a modern Angular component library
          built with TailwindCSS and Angular CDK.
        </p>
      </section>
        ...
        @if (showModal()) {
          ...
          >
            ...
            <div class="flex justify-end gap-2">
              <ui-button variant="outline" (click)="showModal.set(false)">
                Cancel
              </ui-button>
              <ui-button variant="primary" (click)="showModal.set(false)">
                Confirm
              </ui-button>
            </div>
          </ui-modal>
      ...
      <section>
        ...
        <div class="flex gap-4">
          ...
          <ui-tooltip text="Another tooltip" position="bottom">
            <button class="px-4 py-2 bg-secondary-600 text-white rounded-md">
              Hover me too
            </button>
          </ui-tooltip>
        </div>
